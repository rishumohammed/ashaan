...
<head>
  ...
  <title>ASHAAN BY AMAN SHAN · About</title>
  <meta name="description" content="Welcome to Ashaan. My name is Aman Shan, and I am based in Calicut. I am a videographer who is deeply passionate about turning real moments into cinematic stories." />
    ...
    <div class="container container--wide">
      <nav class="nav" aria-label="Primary">
        ...
        <div class="nav-links" role="navigation">
          ...
          <a href="<?php echo e(url('/about')); ?>" aria-current="page">About</a>
      ...
      <div class="container container--wide">
        <div class="hero-grid">
          <div class="hero-text">
            ...
            <p class="hero-sub">
              Welcome to Ashaan. My name is Aman Shan, and I am based in Calicut. I am a videographer who is deeply passionate about turning real moments into cinematic stories. What started out as a simple interest in capturing everyday scenes has grown into a dedicated creative journey.
            </p>
            <div class="hero-cta-row">
              <a class="btn btn--primary btn--lg" href="<?php echo e(url('/contact')); ?>">Start a project</a>
          ...
          <div class="hero-media">
            <img src="<?php echo e(asset($settings['studio_hero'] ?? 'assets/img/studio-hero.jpg')); ?>" alt="ASHAAN BY AMAN SHAN" />
    ...
    <section class="closing-cta">
      <div class="container container--narrow">
        ...
        <div class="cta-row">
          ...
          <a class="btn btn--ghost btn--lg" href="<?php echo e(url('/contact')); ?>">Contact me</a>
        </div>
      </div>
    </section>
...
<?php /**PATH D:\xampp\htdocs\Aman shah\resources\views/about.blade.php ENDPATH**/ ?>