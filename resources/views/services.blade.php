...
<head>
  ...
  <title>Ashaan By Aman Shah · Services</title>
  <meta name="description" content="Services and packages for cinematic visual storytelling and videography by Ashaan, founded by Aman Shah." />
      ...
      <div class="container container--wide">
        <div class="hero-grid">
          ...
          <div class="hero-media">
            <img src="{{ asset($settings['services_hero'] ?? 'assets/img/services-hero.jpg') }}" alt="Ashaan By Aman Shah working on set" />
            <div class="floating-tag ft-top">
              <span class="pill">Process</span>
              CINEMATIC VISUALS
            </div>
            <div class="floating-tag ft-bottom">
              Aman Shah, Founder of Ashaan
            </div>
          </div>
        </div>
      </div>
