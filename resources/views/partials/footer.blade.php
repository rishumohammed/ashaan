  <footer class="site-footer">
    <div class="container container--wide">
      <div class="footer-top">
        <div class="footer-brand">
          ...
          @if($footerLogo && $footerLogo->image_url)
            <span class="brand"><img src="{{ $footerLogo->image_url }}" alt="Ashaan By Aman Shah" style="max-height: 59px; width: auto;" /></span>
          @else
            <span class="brand"><span class="brand-mark" aria-hidden="true"></span> ASHAAN BY AMAN SHAH</span>
          @endif
      ...
      <div class="footer-bottom">
        <span>© 2026 Ashaan By Aman Shah. All Rights Reserved.</span>
