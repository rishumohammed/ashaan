...
<head>
  ...
  <title>Ashaan By Aman Shah — Visual Storyteller</title>
  <meta name="description" content="Welcome to Ashaan, the creative portfolio of Aman Shah. A visual storyteller and videographer focused on creating cinematic, emotion-driven visuals." />
      ...
      <div class="container container--wide">
        <div class="hero-grid">
          <div class="hero-text">
            ...
            <p class="hero-sub">
              Welcome to Ashaan. I am Aman Shah, a visual storyteller and videographer focused on creating cinematic, emotion-driven visuals. From raw moments to refined edits, this is where my ideas come to life.
            </p>
          ...
          <div class="hero-media reveal">
            <img src="{{ asset($settings['index_hero'] ?? 'assets/img/hero-portrait.jpg') }}" alt="Ashaan By Aman Shah Portrait" />
          </div>
        </div>
